...
export const translations = {
  en: {
    ...
    aiVideoStudio: {
      ...
      description: "Orchestrate multiple AI models to create the perfect video. Generate voice, visuals, and music layer by layer.",
      ...
      visuals: "Visuals",
      scene: "Scene",
      promptForScene: "Prompt for scene {num}",
      selectVideoModel: "Select Video Model",
      generateClip: "Generate Clip",
      music: "Background Music",
      musicPrompt: "Describe the music style (e.g., upbeat synthwave)",
      selectMusicModel: "Select Music Model",
      generateMusic: "Generate Music",
      preview: "Preview & Render",
      previewPlaceholder: "Generated assets will be combined and previewed here.",
  ...
  vi: {
    ...
    aiVideoStudio: {
      ...
      description: "Điều phối nhiều mô hình AI để tạo ra video hoàn hảo. Tạo giọng nói, hình ảnh và âm nhạc theo từng lớp.",
      selectProduct: "Chọn sản phẩm để bắt đầu",
      noProducts: "Không có sản phẩm nào có kịch bản.",
      script: "Kịch bản",
      assetGeneration: "Tạo tài sản",
      voiceover: "Lồng tiếng",
      selectVoiceModel: "Chọn mô hình giọng nói",
      generateVoiceover: "Tạo giọng nói",
      generating: "Đang tạo...",
      visuals: "Hình ảnh",
      scene: "Cảnh",
      promptForScene: "Prompt cho cảnh {num}",
      selectVideoModel: "Chọn mô hình video",
      generateClip: "Tạo clip",
      music: "Nhạc nền",
      musicPrompt: "Mô tả phong cách âm nhạc (ví dụ: synthwave sôi động)",
      selectMusicModel: "Chọn mô hình âm nhạc",
      generateMusic: "Tạo nhạc",
      preview: "Xem trước & Kết xuất",
      previewPlaceholder: "Các tài sản đã tạo sẽ được kết hợp và xem trước tại đây.",
