...
export const LanguageSwitcher: React.FC = () => {
    ...
    const inactiveClasses = "text-gray-600 hover:bg-primary-500/10 hover:text-primary-600";

    return (
        <div className="flex items-center space-x-1 p-1 bg-gray-100 rounded-lg border border-gray-200/80">
            <button
